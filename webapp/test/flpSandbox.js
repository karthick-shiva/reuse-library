		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reuse App",
									"targetURL": "#commoboprojectreuse-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commoboprojectreuse-display": {
								"semanticObject": "commoboprojectreuse",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mobo.projectreuse",
									"url": sap.ui.require.toUrl("com/mobo/projectreuse")
								}
							}
						}
					}
